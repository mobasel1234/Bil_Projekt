...
public class RentalAgreement {
    ...
    public RentalAgreement(int rental_id, int car_id, int customer_id,
                           LocalDate start_date, LocalDate end_date, boolean first_payment_paid,
    ...
    public boolean isFirst_payment_paid() {
        return first_payment_paid;
    }

    public void setFirst_payment_paid(boolean first_payment_paid) {
        this.first_payment_paid = first_payment_paid;
    }
